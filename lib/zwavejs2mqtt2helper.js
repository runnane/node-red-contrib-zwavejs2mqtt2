...
class zwavejs2mqtt2helper {
    ...
    static formatPayload(payload, device) {
        ...
        if ("color" in payload && "x" in payload.color) {
            ...
            var rgb = zwavejs2mqtt2helper.cie2rgb(payload.color.x, payload.color.y, bri);
            var hsv = zwavejs2mqtt2helper.rgb2hsv(rgb.r, rgb.g, rgb.b);
            result['color'] = {
                "rgb":rgb,
                "hsv":hsv
            };
...
module.exports = zwavejs2mqtt2helper;
